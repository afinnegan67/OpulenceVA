...
app.get("/api/problems", async (req, res) => {
  ...
  try {
    ...
    const problemsUrl = `https://api.airtable.com/v0/${AIRTABLE_BASE_ID}/Problems?pageSize=100`;
    const projectsUrl = `https://api.airtable.com/v0/${AIRTABLE_BASE_ID}/Projects?pageSize=100`;
